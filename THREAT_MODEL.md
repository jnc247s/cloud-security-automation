...
producers, plus the merged 5E S3 and referenced-KMS producer
Baseline: `main` commit `8ea9df86f8c6ae623ef41ebb836e6b3b7d052393`
...
infrastructure, remediation execution, or AI agent is implemented. The merged 5E producer
collects facts only. The 5F security preflight is complete but does not add runtime behavior.
