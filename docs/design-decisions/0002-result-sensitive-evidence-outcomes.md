...
manifests, artifacts, and outcomes; remaining Sprint 0--4 legacy collectors retain their accepted
graphless behavior, and no Sprint 6 rule consumes source outcomes yet.
...
declared-source manifest atomically. The accepted 5A and 5B producers construct their complete
manifests; 5C--5F collectors and every deterministic Sprint 6 rule remain unimplemented merely
