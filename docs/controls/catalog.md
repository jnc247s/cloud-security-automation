...
does not change the executable catalog: Sprint 5 remains `IN PROGRESS`, the bounded 5G closure is
pending acceptance and merge, and every planned Sprint 6 control below remains unregistered and disabled.
