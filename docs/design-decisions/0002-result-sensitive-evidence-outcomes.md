...
manifests, artifacts, and outcomes; the accepted 5C IAM producer does likewise. The remaining
Sprint 0--4 legacy collectors retain their accepted graphless behavior, and no Sprint 6 rule
consumes source outcomes yet.
...
declared-source manifest atomically. The accepted 5A through 5C producers construct their complete
manifests; 5D--5F collectors and every deterministic Sprint 6 rule remain unimplemented merely
